...
<section class="container mb-5">
    <div class="card ">
        <div class="card-header bg-warning text-white font-weight-bold">
            <span>تازه و لبنی</span>
        </div>
        <div class="center slider w-100 p-0 card-block">
            <div class="main-carousel text-center"
                 data-flickity='{ "cellAlign": "left", "contain": true }'>
                <div class="carousel-cell">
                    <img src="image/biogelz.jpg" alt="aks" width="300" height="300">
                    <p>چیپس</p>
                    <p>1000 تومان</p>
                    <p>500 تومان</p>
                </div>
                <div class="carousel-cell">
                    <img src="image/labani.jpg" alt=""  width="300" height="300">
                </div>
                <div class="carousel-cell">
                    <img src="image/zhele.jpg" alt=""  width="300" height="300">
                    <p>پودر ژله پرتقالی</p>
                    <p>1000 تومان</p>
                    <p></p>
                </div>
